(function (root) {
  ...
  var ENVELOPES = {
    ...
    bureau: {
      ...
      programs: {"base":{"equipments":[{"id":"desk","label":"Plan de travail","required":true,"footprint":{"w":1.2,"d":0.6},"anchor":"wall","usage":[{"face":"front","min":0.9}],"program":"bureau"}],"relations":[]}},
      catalogs: {"base":{"equipments":[{"id":"desk","label":"Plan de travail","required":true,"footprint":{"w":1.2,"d":0.6},"anchor":"wall","usage":[{"face":"front","min":0.9}],"program":"bureau"},{"id":"bookcase","label":"Bibliothèque","required":false,"assumed":true,"minRoomArea":7,"footprint":{"w":1.2,"d":0.35},"anchor":"wall","usage":[{"face":"front","min":0.6}],"program":"bureau"}],"relations":[]}}
    },
    buanderie: {
